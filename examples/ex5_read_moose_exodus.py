...
exodus_data = ExodusReader(output_file)

coords = exodus_data.get_coords()
print('Nodal Coordinates N[x,y,z]:')
print(type(coords))
print(coords.shape)
print()

sim_time = exodus_data.get_time()
print('Simulation time [t]:')
print(type(sim_time))
print(sim_time.shape)
print()

disp = exodus_data.get_node_data('disp_x')
print('X Displacement at nodes [N,t]:')
print(type(disp))
print(disp.shape)
print()

strain = exodus_data.get_elem_data('strain_xx',1)
